...
architecture kxx_rom_arc of kxx_rom is
	...
	constant kxx : sbox := (x"7", x"D", x"E", x"3", x"0", x"6", x"9", x"A", -- R=0; X:0-7
							x"1", x"2", x"8", x"5", x"B", x"C", x"4", x"F", -- R=0; X:8-15
							x"4", x"8", x"9", x"3", x"E", x"B", x"5", x"0", -- R=1; X:0-7
							x"A", x"6", x"7", x"C", x"D", x"1", x"2", x"F"  -- R=1; X:8-15
);
